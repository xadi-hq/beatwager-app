...
return [
    ...
    'dispute' => [
        ...
        'vote_reminder' => [
            ...
            'fallback_template' => "⚖️ JUDGES NEEDED!\n\nThe dispute on \"{item_title}\" awaits your verdict!\n\n📊 {votes_received}/{votes_required} judges have ruled\n⏰ Expires: {expires_at}\n\nWho will step up and bring justice?",
            'tone_hints' => ['urgent', 'encouraging', 'dramatic'],
            'personality_notes' => 'Create urgency with flair. Frame voters as judges bringing justice. Make participation feel important.',
            'max_words' => 40,
        ],
    ],
