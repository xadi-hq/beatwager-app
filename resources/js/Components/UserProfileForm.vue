...
const props = defineProps<{
    user: {
        // taunt_line?: string; // Hidden - not yet implemented in bot
        birthday?: string;
    };
}>();
...
const profileForm = useForm({
    // taunt_line: props.user.taunt_line || '', // Hidden - not yet implemented in bot
...
<template>
    <div>
        ...
        <form @submit.prevent="submitProfile" class="space-y-6">
            <!-- Taunt Line - Hidden until bot integration is complete
            <div>
