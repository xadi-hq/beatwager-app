...
<template>
    <AppLayout :title="wager.title">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="mb-4">
                <a href="/me" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm inline-flex items-center gap-1">
            ...
            <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                        ...
                        <div class="text-sm text-neutral-500 dark:text-neutral-400">Total Points</div>
                    </div>
                    <div>
