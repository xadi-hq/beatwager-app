...
<template>
    <AppLayout title="My Dashboard">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div v-if="groups.length > 1" class="mb-6 flex items-center gap-3">
                <label class="text-sm font-medium text-neutral-700 dark:text-neutral-300">
                    Filter:
                </label>
                <select
                    v-model="selectedGroupFilter"
                    class="px-3 py-1.5 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 border border-neutral-300 dark:border-neutral-700 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm"
                >
