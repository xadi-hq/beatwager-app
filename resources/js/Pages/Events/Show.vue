            ...
            <div class="lg:hidden">
                <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-lg p-6 mb-6">
                    ...
                    <div class="mt-6 space-y-3">
                        ...
                        <!-- Record Attendance Button (Past events only, not yet recorded) -->
                        <a
                            v-if="canRecordAttendance"
                            :href="`/events/${event.id}/attendance`"
                            class="block w-full px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium text-center transition-colors"
                        >
                            📊 Record Attendance
                        </a>
